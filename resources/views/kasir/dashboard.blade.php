...
<div class="kasir-shell">
    ...
    <main class="kasir-main">
        <div class="k-pageheader">
            <div>
                <h1>Dashboard</h1>
                <p class="subtitle">Selamat datang, {{ session('kasir_user_name', 'Kasir') }}. Pantau pesanan masuk hari ini.</p>
            </div>
        ...
        <div class="k-stat-grid">
            ...
            <div class="k-stat is-info">
                ...
                <div class="k-stat-value">{{ $diprosesCount }}</div>
                <div class="k-stat-foot">Pesanan diproses</div>
            </div>
            <div class="k-stat is-danger">
                ...
                <div class="k-stat-value">{{ $belumBayarCount }}</div>
            ...
            <div class="k-stat is-success">
                ...
                <div class="k-stat-value">{{ format_idr($todayRevenue) }}</div>
                    ...
                    <tbody>
                        @foreach($recentOrders as $i => $order)
                            @php
                                ...
                                $stCls = 'is-info';
                                if ($st === 'belumdibayar') $stCls = 'is-warn';
                                elseif ($st === 'selesai')   $stCls = 'is-success';
                                elseif ($st === 'diproses')  $stCls = 'is-info';
                            @endphp
                            <tr>
                                ...
                                <td><span class="k-badge {{ $stCls }}">{{ ucfirst($order->status_pemesanan) }}</span></td>
