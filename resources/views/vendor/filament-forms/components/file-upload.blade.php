            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <div
                            class="shadow-top z-[1] flex h-96 w-full flex-col overflow-auto bg-gray-50 bg-white/30 lg:h-full lg:max-w-xs lg:shadow-none"
                        >
                                            ...
                                            <div class="w-full space-y-3">
                                                @foreach ([
                                                    ...
                                                    >
                                                        ...
                                                        <input
                                                            @class([
                                                                'block w-full border-none text-sm transition duration-75 focus-visible:border-primary-500 focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-primary-500 disabled:opacity-70 dark:bg-gray-700  dark:focus-visible:border-primary-500',
                                                            ])
