...
<div
    ...
    {{
        $attributes
            ...
            ->class([
                'fi-fo-wizard',
                'fi-contained rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 bg-white dark:ring-white/10' => $isContained,
            ])
    }}
>
    <input
    ...
    <ol
        ...
        @class([
            ...
            'rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 bg-white dark:ring-white/10' => ! $isContained,
        ])
        x-ref="header"
    >
                ...
                @if (! $loop->last)
                    ...
                    >
                        <svg
                            ...
                            viewBox="0 0 22 80"
                            class="h-full w-full text-gray-200 /5 rtl:rotate-180"
                        >
                            <path
                                d="M0 -2L20 40L0 82"
