...
@if (count($actions))
    <div
        @if ($this->areFormActionsSticky())
            ...
            x-bind:class="{
                'fi-sticky sticky bottom-0 -mx-4 transform bg-white p-4 shadow-lg ring-1 ring-gray-950/5 transition bg-white dark:ring-white/10 md:bottom-4 md:rounded-xl':
                    isSticky,
            }"
        @endif
