<x-filament::page>
    <x-filament::card>
        ...
        <h1 style="font-size:22px; font-weight:800; color:#111827; margin-bottom:16px;">Laporan Laba Rugi</h1>
        ...
        <div style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:12px; margin-bottom:20px;">
            ...
            <form method="GET" action="{{ route('laporan.laba-rugi') }}"
                ...
                <label style="font-size:13px; font-weight:600; color:#374151; white-space:nowrap;">
                    Periode:
                </label>
            ...
            <table class="w-full text-sm border border-gray-200" style="border-collapse:collapse;">
                ...
                <tfoot>
                    <tr style="background:#f0fdf4; font-weight:700;">
                        <td colspan="2" class="px-4 py-2 border text-right" style="color:#166534;">Total Pendapatan</td>
                        <td class="px-4 py-2 border text-right" style="color:#166534;">{{ rupiah($totalPendapatan) }}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
        ...
        {{-- ── BEBAN ── --}}
        <div style="margin-top:20px;">
            <div style="font-weight:700; font-size:14px; color:#111827; border-left:4px solid #dc2626; padding-left:10px; margin-bottom:10px;">
                Beban
            </div>
            <table class="w-full text-sm border border-gray-200" style="border-collapse:collapse;">
                ...
                <tfoot>
                    <tr style="background:#fef2f2; font-weight:700;">
                        <td colspan="2" class="px-4 py-2 border text-right" style="color:#991b1b;">Total Beban</td>
                        <td class="px-4 py-2 border text-right" style="color:#991b1b;">{{ rupiah($totalBeban) }}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
        ...
        <div style="margin-top:20px; display:flex; justify-content:flex-end;">
            <div style="background:{{ $labaBersih >= 0 ? 'linear-gradient(135deg,#16a34a,#15803d)' : 'linear-gradient(135deg,#dc2626,#b91c1c)' }}; color:#fff; border-radius:12px; padding:16px 28px; text-align:right; min-width:280px; box-shadow:0 4px 12px rgba(0,0,0,.15);">
                ...
                @if($labaBersih < 0)
                    <div style="font-size:11px; opacity:.8; margin-top:2px;">(Rugi)</div>
                @endif
            </div>
        </div>
